...
source: "https://developer.mozilla.org/en-US/docs/Web/SVG/Reference/Attribute/systemLanguage"
...
- `<language-tags>`
  - : The value is a set of comma-separated tokens, each of which must be a valid {{glossary("BCP 47 language tag")}}.
