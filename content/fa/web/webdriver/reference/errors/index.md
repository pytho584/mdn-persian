...
source: "https://developer.mozilla.org/en-US/docs/Web/WebDriver/Reference/Errors"
...
| [`unknown error`](/en-US/docs/Web/WebDriver/Reference/Errors/UnknownError)                        | {{HTTPStatus(500, "500 Internal Server Error")}} | An unknown error occurred in the driver while processing the [command](/en-US/docs/Web/WebDriver/Reference/Command).                                                                                                                                                                                |
