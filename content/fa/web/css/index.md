...
- [Flexible box](/en-US/docs/Web/CSS/Guides/Flexible_box_layout)، [multi-column](/en-US/docs/Web/CSS/Guides/Multicol_layout) و [grid](/en-US/docs/Web/CSS/Guides/Grid_layout) layouts
...
- [CSS propertyها](/en-US/docs/Web/CSS/Reference/Properties)
  - : مرجعی برای همهٔ CSS propertyها.
- [CSS selectorها](/en-US/docs/Web/CSS/Reference/Selectors)
  - : مرجعی برای CSS selectorها، [combinatorها](/en-US/docs/Web/CSS/Reference/Selectors/Combinators)، [pseudo-classها](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-classes) و [pseudo-elementها](/en-US/docs/Web/CSS/Reference/Selectors/Pseudo-elements).
- [CSS at-ruleها](/en-US/docs/Web/CSS/Reference/At-rules)
  - : مرجعی برای CSS at-ruleها، از جمله media queryها.
- [CSS valueها](/en-US/docs/Web/CSS/Reference/Values)
  - : مرجعی برای CSS keywordها، [نوع داده‌ها](/en-US/docs/Web/CSS/Reference/Values/Data_types) و [تابع‌ها](/en-US/docs/Web/CSS/Reference/Values/Functions).
