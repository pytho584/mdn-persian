...
source: "https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@property/initial-value"
...
The **`initial-value`** descriptor of the {{cssxref("@property")}} [at-rule](/en-US/docs/Web/CSS/Guides/Syntax/At-rules) specifies the initial value for the registered [CSS custom property](/en-US/docs/Web/CSS/Reference/Properties/--*).
