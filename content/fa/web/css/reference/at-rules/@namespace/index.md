...
source: "https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@namespace"
...
**`@namespace`** is an [at-rule](/en-US/docs/Web/CSS/Guides/Syntax/At-rules) that defines XML [namespaces](/en-US/docs/Glossary/Namespace) to be used in a [CSS](/en-US/docs/Glossary/CSS) [style sheet](/en-US/docs/Web/API/StyleSheet).
