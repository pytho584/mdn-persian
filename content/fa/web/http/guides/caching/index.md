---
title: "HTTP caching"
source: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/Caching"
...
> [!NOTE]
> The `no-cache` directive (or equivalent, such as `max-age=0, must-revalidate`) does not guarantee revalidation for history navigations — such as those made using the <kbd>Back</kbd> button.
