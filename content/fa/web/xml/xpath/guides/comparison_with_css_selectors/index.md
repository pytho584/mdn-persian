...
source: "https://developer.mozilla.org/en-US/docs/Web/XML/XPath/Guides/Comparison_with_CSS_selectors"
...
| [XPath feature](/en-US/docs/Web/XML/XPath)                                                                                                                                                                             | [CSS equivalent](/en-US/docs/Web/CSS/Guides/Selectors)                                                                                                                                               |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
