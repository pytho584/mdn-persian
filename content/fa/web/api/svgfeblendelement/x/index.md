...
source: "https://developer.mozilla.org/en-US/docs/Web/API/SVGFEBlendElement/x"
...
It reflects the {{SVGElement("feBlend")}} element's {{SVGAttr("x")}} filter primitive attribute value. The `<feBlend>` SVG filter blends two input images together using commonly used imaging software [blending modes](/en-US/docs/Web/CSS/Reference/Values/blend-mode).
