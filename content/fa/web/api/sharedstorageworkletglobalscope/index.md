...
source: "https://developer.mozilla.org/en-US/docs/Web/API/SharedStorageWorkletGlobalScope"
...
- {{domxref("SharedStorageWorkletGlobalScope.register", "register()")}} {{deprecated_inline}} {{non-standard_inline}}
