...
source: "https://developer.mozilla.org/en-US/docs/Web/API/WebSocketStream"
...
- {{domxref("WebSocketStream.WebSocketStream", "WebSocketStream()")}} {{experimental_inline}} {{non-standard_inline}}
  - : Creates a new `WebSocketStream` object instance.

## Instance properties

- {{domxref("WebSocketStream.url", "url")}} {{ReadOnlyInline}} {{experimental_inline}} {{non-standard_inline}}
  - : Returns the URL of the WebSocket server that the `WebSocketStream` instance was created with.
- {{domxref("WebSocketStream.closed", "closed")}} {{ReadOnlyInline}} {{experimental_inline}} {{non-standard_inline}}
...
- {{domxref("WebSocketStream.opened", "opened")}} {{ReadOnlyInline}} {{experimental_inline}} {{non-standard_inline}}
...
- {{domxref("WebSocketStream.close", "close()")}} {{experimental_inline}} {{non-standard_inline}}
