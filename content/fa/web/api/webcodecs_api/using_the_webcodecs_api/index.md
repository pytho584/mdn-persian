...
source: "https://developer.mozilla.org/en-US/docs/Web/API/WebCodecs_API/Using_the_WebCodecs_API"
...
Finally, `VideoFrame` objects can also be generated by decoding `EncodedVideoChunk` objects via a `VideoDecoder`, as shown in the [Decoding video](#decoding_video) section above.
...
See the [Codec selection](/en-US/docs/Web/API/WebCodecs_API/Codec_selection#audio_codecs) guide for guidance on choosing between Opus and AAC.
