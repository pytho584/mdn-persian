...
source: "https://developer.mozilla.org/en-US/docs/Web/API/WorkerNavigator"
...
- {{domxref("WorkerNavigator.globalPrivacyControl")}} {{ReadOnlyInline}}
...
- {{domxref("WorkerNavigator.serial")}} {{ReadOnlyInline}} {{SecureContext_Inline}}
