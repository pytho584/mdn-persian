...
| [Clickjacking prevention](/en-US/docs/Web/Security/Attacks/Clickjacking)                                                               | High    | Low        | Yes      | Control how your site may be framed within an {{htmlelement("iframe")}} to prevent [clickjacking](/en-US/docs/Web/Security/Attacks/Clickjacking).                                                                                                                             |
| [CSRF prevention](/en-US/docs/Web/Security/Attacks/CSRF)                                                                               | High    | Unknown    | Varies   | Protect against [Cross-site request forgery](/en-US/docs/Glossary/CSRF) (CSRF) attacks.                                                                                                                                                                                       |
